package com.example.testclassification.ml;
...
public final class FrontClassificationModelLite {
  @NonNull
  private final Model model;

  private FrontClassificationModelLite(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    model = Model.createModel(context, "front_classification_model_lite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static FrontClassificationModelLite newInstance(@NonNull Context context) throws
      IOException {
    return new FrontClassificationModelLite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static FrontClassificationModelLite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new FrontClassificationModelLite(context, options);
  }
