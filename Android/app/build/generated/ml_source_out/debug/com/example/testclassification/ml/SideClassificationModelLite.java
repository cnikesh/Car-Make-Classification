...
public final class SideClassificationModelLite {
  @NonNull
  private final Model model;

  private SideClassificationModelLite(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    model = Model.createModel(context, "side_classification_model_lite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static SideClassificationModelLite newInstance(@NonNull Context context) throws
      IOException {
    return new SideClassificationModelLite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static SideClassificationModelLite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new SideClassificationModelLite(context, options);
  }
