...
public final class AngleDetectionModelLite {
  @NonNull
  private final Model model;

  private AngleDetectionModelLite(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "angle_detection_model_lite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static AngleDetectionModelLite newInstance(@NonNull Context context) throws IOException {
    return new AngleDetectionModelLite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static AngleDetectionModelLite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new AngleDetectionModelLite(context, options);
  }
