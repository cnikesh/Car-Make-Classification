...
public final class BackClassificationModelLite {
  @NonNull
  private final Model model;

  private BackClassificationModelLite(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    model = Model.createModel(context, "back_classification_model_lite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static BackClassificationModelLite newInstance(@NonNull Context context) throws
      IOException {
    return new BackClassificationModelLite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static BackClassificationModelLite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new BackClassificationModelLite(context, options);
  }
